...
import sustech.sustoilmd.complexBlocks.CleanTable_ScreenHandler;

public class CleanTable_Screen extends HandledScreen<CleanTable_ScreenHandler> {
    private static final Identifier TEXTURE = new Identifier("sustoilmd", "textures/gui/clean_table.png");
