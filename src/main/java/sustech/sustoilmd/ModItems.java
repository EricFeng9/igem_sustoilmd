...
public class ModItems {
    ...
    public static final RegistryKey<Item> EXPLANATORY_LIQUID_B_KEY = RegistryKey.of(RegistryKeys.ITEM, Identifier.of(SustoilMD.MOD_ID, "explanatory_liquid_b"));
    ...
    public static final RegistryKey<Item> EXPLANATORY_LIQUID_BP_KEY = RegistryKey.of(RegistryKeys.ITEM, Identifier.of(SustoilMD.MOD_ID, "explanatory_liquid_bp"));
    public static final Item EXPLANATORY_LIQUID_BP = register(
            new Item(new Item.Settings()),
            EXPLANATORY_LIQUID_BP_KEY
    );
    //explanatory liquid P 降解液P
    public static final RegistryKey<Item> EXPLANATORY_LIQUID_P_KEY = RegistryKey.of(RegistryKeys.ITEM, Identifier.of(SustoilMD.MOD_ID, "explanatory_liquid_p"));
    public static final Item EXPLANATORY_LIQUID_P = register(
            new Item(new Item.Settings()),
            EXPLANATORY_LIQUID_P_KEY
    );
    //medium 培养基
    public static final RegistryKey<Item> MEDIUM_KEY = RegistryKey.of(RegistryKeys.ITEM, Identifier.of(SustoilMD.MOD_ID, "medium"));
