...
import sustech.sustoilmd.fluids.Oil_Fluid;
import sustech.sustoilmd.fluids.Oil_Fluid_Block;

public class ModFluids {
    // -----------------------------
    // 1) 注册用到的 Identifier
    // -----------------------------
    public static final Identifier STILL_OIL_ID = new Identifier(SustoilMD.MOD_ID, "still_oil");
    public static final Identifier FLOWING_OIL_ID = new Identifier(SustoilMD.MOD_ID, "flowing_oil");
    public static final Identifier OIL_FLUID_BLOCK_ID = new Identifier(SustoilMD.MOD_ID, "oil_fluid_block");
    public static final Identifier OIL_BUCKET_ID = new Identifier(SustoilMD.MOD_ID, "oil_bucket");
    // -----------------------------
    // 2) 流体实例、流体方块、油桶
    // -----------------------------
